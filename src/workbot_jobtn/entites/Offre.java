...
public class Offre {
    ...
    public Offre(Integer id, String titre, String Salaire, String description, String domaine, String dateExpiration, String dureeStage, String typeStage, String dureeContrat, String anneeExperience, String modeTravail, String lieu, Integer id_soc, Integer id_test, TypeOffre typeOffre) {
        this.id = id;
        this.titre = titre;
